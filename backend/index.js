...
mongoose.connect(uri)
  ...
  //api route - to add dummy data for holdings 
...
// // });
// try{
// await HoldingsModel.insertMany(temp);
// res.send("done");
// }
// catch(err){
...
//   });
 ...
 //api route - to add dummy data for positions  alternative is thunderclient
...
// ];
// try{
// await PositionsModel.insertMany(temp);
// res.send("done");
// }
// catch(err){
// res.status(500).send(err.message);
